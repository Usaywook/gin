...
class ReplayBuffer(object):
    ...
    def add(self, obs_t, action, reward, obs_tp1, done, cost):
    ...
    def _encode_sample(self, idxes):
        ...
        for i in idxes:
            ...
            dones.append(done)
            costs.append(cost)
        return np.array(obses_t), np.array(actions), np.array(rewards), np.array(obses_tp1), np.array(dones), np.array(costs)
