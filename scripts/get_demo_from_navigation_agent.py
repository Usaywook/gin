...
if __name__ == '__main__':
    ...
    parser.add_argument('--game', type=str, default='CarlaNavigation-v0',
                        help='CarlaCompound-v0')
    ...
    parser.add_argument('--use-dict-obs', action='store_true', default=True, help='use dictionary for obs space')
    parser.add_argument('--use-camera', action='store_true', default=True, help='use raw camera for obs space')
    parser.add_argument('--use-birdeye', action='store_true', default=True, help='use birdeye for obs space')
    parser.add_argument('--use-lidar', action='store_true', default=True, help='use lidar for obs space')
