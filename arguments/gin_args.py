def set_parser(parser):
    subparser = parser.add_parser('gin')
    subparser.add_argument('--trainable_edge', action='store_true', default=False)
    subparser.add_argument('--distpool', action='store_true', default=True)
    subparser.add_argument('--weighted_graph', action='store_true', default=True)
    ...
    subparser.add_argument('--tp_epoch', type=int, default=1)
    subparser.add_argument('--tp_warmup', type=int, default=10000)
    ...
    subparser.add_argument('--hazard', action='store_true', default=True)

    # for HMM
    subparser.add_argument('--num_sample', type=int, default=2000)
    subparser.add_argument('--num_state', type=int, default=5)
    subparser.add_argument('--n_iter', type=int, default=100)

    # subparser.add_argument('--tp_loader', action='store_true', default=True)
    subparser.add_argument('--tp_data_path', type=str, default='demonstrations/CarlaNavigation/rule.pt')
