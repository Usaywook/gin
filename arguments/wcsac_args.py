def set_parser(parser):
    subparser = parser.add_parser('wcsac')

    subparser.add_argument('--cvar', type=float, default=0.1)
    subparser.add_argument('--damp_scale', type=float, default=100)
    subparser.add_argument('--max_constraint', type=float, default=0.01)
    subparser.add_argument('--kappa_lr', type=float, default=1.5e-3)
    ...
    subparser.add_argument('--automatic_entropy_tuning', action='store_true', default=False,
