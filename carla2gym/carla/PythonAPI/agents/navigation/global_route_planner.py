...
import carla
from carla2gym.carla.PythonAPI.agents.navigation.local_planner import RoadOption
from carla2gym.carla.PythonAPI.agents.tools.misc import vector
...
class GlobalRoutePlanner(object):
    ...
    def setup(self, use_lane_change_link=True):
        """
    ...
    def _path_search(self, origin, destination):
        ...
        origin      :   carla.Locati on object of start position
