...
import carla
from carla2gym.carla.PythonAPI.agents.tools.misc import is_within_distance_ahead, is_within_distance, compute_distance
    ...
    def _bh_is_vehicle_hazard(self, ego_wpt, ego_loc, vehicle_list,
        ...
        for target_vehicle in vehicle_list:
            ...
            if target_wpt.road_id != ego_wpt.road_id or \
                ...
                if next_wpt is None:
                    print("no next waypoints")
                    next_wpt = target_wpt.next(4.5)[0]
